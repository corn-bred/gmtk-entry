...
AudioManager::AudioManager(AudioManager &&other) : 
...
AudioManager &AudioManager::operator=(AudioManager &&other) {
    if (this != &other) {
...
void AudioManager::PlaySound(AudioData &buffer) {
...
void AudioManager::SetListenerVelocity(glm::vec3 Velocity) {
    alListener3f(AL_VELOCITY, Velocity.x, Velocity.y, Velocity.z);
}

void AudioManager::SetListenerOrientation(glm::vec3 forward, glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f)) {
