...
`g++ src/main.cpp src/misc/glad.c src/misc/shaders.cpp src/game.cpp src/scenes.cpp src/misc/collision.cpp src/misc/utility.cpp src/globals.cpp src/misc/audiomanager.cpp src/entity.cpp src/misc/camera2D.cpp -o bin/main.exe -I include -L lib -lglfw3dll -lOpenAL32`
